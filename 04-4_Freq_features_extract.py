...
def get_MAC():#Obdtains MAC
    ...
    list=['MAC_1','MAC_2','MAC_3','MAC_4','MAC_5','MAC_6','MAC_7','MAC_8','MAC_9','MAC_10','MAC_11','MAC_12']
...
def get_curve_stainU_flexG(): #Obdtains Curvature, Strain energy, and Flexability
    ...
    col=['Curve_v1_0','Curve_v1_1','Curve_v1_2','Curve_v1_3','Curve_v1_4','Curve_v1_5','Curve_v1_6','Curve_v1_7','Curve_v1_8','Curve_v1_9',
        'Curve_v2_0','Curve_v2_1','Curve_v2_2', 'Curve_v2_3', 'Curve_v2_4', 'Curve_v2_5', 'Curve_v2_6', 'Curve_v2_7', 'Curve_v2_8', 'Curve_v2_9',
        'Curve_v3_0','Curve_v3_1','Curve_v3_2', 'Curve_v3_3', 'Curve_v3_4', 'Curve_v3_5', 'Curve_v3_6', 'Curve_v3_7', 'Curve_v3_8', 'Curve_v3_9']
    df_curve=pd.DataFrame(data=curve,columns=col)
    df_U=pd.DataFrame(data=U,columns=['StrainU_v1','StrainU_v2','StrainU_v3'])
    df_G=pd.DataFrame(data=G,columns=['Flex_0','Flex_1','Flex_2','Flex_3','Flex_4','Flex_5','Flex_6','Flex_7','Flex_8','Flex_9'])
...
def add_DMG(df,seg=50): #Add damage states to 
    ...
    for i in range(len(damage)):
        run_i=i//seg
        if run_i==0:damage[i]=0
        elif run_i==1: damage[i]=1
        elif run_i==2: damage[i]=2
        elif run_i==3: damage[i]=3
        elif run_i==4: damage[i]=4
        elif run_i==5: damage[i]=5
        elif run_i==6: damage[i]=6
    df['Damage'] = damage
    return df
...
col[29] = 'PCA_Res_18'
#----------- Create files ----------------
for i,el in enumerate(unpickle(sensor_group='all',column_only='True')):
